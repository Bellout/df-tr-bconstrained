...
namespace TestResources {
    ...
    public:
        ...
        TrustRegionModelData() {
            ...
            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -1.8852763136068167E+00, 1.4057919370756236E+00; 
            // bu_mod: 1.1472368639317454E-01, 3.4057919370756147E+00; 
            // tol_tr: 4.4408920985006262E-15; 

            // x: 1.1472368639315578E-01, 2.4057919370756120E+00; 
            // c: -6.2331576328187310E-02; 
            // gx: -4.6867795863161671E-01; 
            // xHx: 0.0000000000000000E+00; 
            // fval: -5.3100953495980407E-01; 
            ...
            // Polynomial [-polynomial_max] (input data):
            prob1.obp.col(0) <<   3.5546808922351243,  -2.7705526272136733,  -1.0196720224457656,   0.0000000000000000,   0.0000000000000000,   0.0000000000000000; 
            v_obp.push_back(prob1.obp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -1.8852763136067934E+00, 4.0579193707566286E-01; 
            // bu_mod: 2.1147236863931047E+00, 4.4057919370755609E+00; 
            // tol_tr: 4.4408920985006262E-15; 

            // x: 2.1147236863919892E+00, 4.4057919370753309E+00; 
            // c: 3.5546808922351243E+00; 
            // gx: -1.0351416040117160E+01; 
            // xHx: 0.0000000000000000E+00; 
            // fval: -6.7967351478820355E+00; 
            // Trial point found (output data):
            //   2.1147236863919892,   4.4057919370753309; 
            // [ From improve_model_nfp(): ]
            // points_shifted: 0.0000000000000000E+00, 0.0000000000000000E+00; 
            // points_shifted: 3.1472368639317894E-01, 4.0579193707561911E-01; 
            // points_shifted: 1.3147236863931557E+00, 4.0579193707561201E-01; 
            // points_shifted: 3.7000000000000000E+01, 5.0000000000000000E+01; 
            // points_shifted: 4.8000000000000000E+01, 4.6000000000000000E+01; 
            // points_shifted: 4.9000000000000000E+01, 5.4000000000000000E+01; 
            // points_shifted: 6.9000000000000000E+01, 4.4000000000000000E+01; 
            // points_shifted: 3.2000000000000000E+01, 3.7000000000000000E+01; 
            // points_shifted: 5.0000000000000000E+01, 4.8000000000000000E+01; 
            // points_shifted: 4.6000000000000000E+01, 4.9000000000000000E+01; 
            // points_shifted: 5.4000000000000000E+01, 6.9000000000000000E+01; 
            // points_shifted: 5.9000000000000000E+01, 3.2000000000000000E+01; 
            // points_shifted: 9.2000000000000000E+01, 1.1000000000000000E+02; 

            // ------------------------------------------------------------------------------------------
            // C++ POINT NEW FUNCTION 

            // Polynomial [-polynomial_max] (input data):
            prob1.pnp.col(0) <<   0.0000000000000000,  -1.6294473727863272,   1.0196720224457654,   2.0000000000000000,   0.0000000000000000,   0.0000000000000000; 
            v_pnp.push_back(prob1.pnp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -6.8527631360679564E-01, -1.5942080629243394E+00; 
            // bu_mod: 3.3147236863931071E+00, 2.4057919370755632E+00; 
            // tol_tr: 2.2204460492503131E-15; 

            // x: 8.1472368383765803E-01, -1.5942080433101173E+00; 
            // c: 0.0000000000000000E+00; 
            // gx: -2.9531187058974040E+00; 
            // xHx: 6.6377468100600412E-01; 
            // fval: -2.2893440248913999E+00; 
            ...
            // x: 3.3147232863931113E+00, 2.4057899756614987E+00; 
            // c: -0.0000000000000000E+00; 
            // gx: 2.9480504204644062E+00; 
            // xHx: -1.0987390465356748E+01; 
            // fval: -8.0393400448923416E+00; 

            // New points (output data) - > new_points = [new_point_max, new_point_min];:
            //   3.3147232863931113,   2.4057899756614987; 
            //   0.8147236838376580,  -1.5942080433101173; 

            // ------------------------------------------------------------------------------------------
            // C++ POINT SOLVE TR SUBPROBLEM 

            // Polynomial [-polynomial_max] (input data):
            prob1.obp.col(0) <<   1.1054181264452043,  -2.1575682495753261,  -0.0958878575287293,   1.8931687706300306,   0.0483868557174896,   0.0451613139951083; 
            v_obp.push_back(prob1.obp);
            ...
            // x: 1.1159521053218842E+00, 9.2757671604631120E-01; 
            // c: 1.1054181264452043E+00; 
            // gx: -2.4966861744844531E+00; 
            // xHx: 1.2483431219800321E+00; 
            // fval: -1.4292492605921669E-01; 
            // Trial point found (output data):
            //   1.1159521053218842,   0.9275767160463112; 

            // ------------------------------------------------------------------------------------------
            // C++ POINT SOLVE TR SUBPROBLEM 

            // Polynomial [-polynomial_max] (input data):
            prob1.obp.col(0) <<   1.7334598164392505,  -2.1789879314504716,  -0.5907144738414045,   1.7886727676599745,   0.0405556909997724,   0.2413364395936342; 
            v_obp.push_back(prob1.obp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -1.8404783367367150E+00, -2.0288537260122879E+00; 
            // bu_mod: 4.0723825473804833E+00, 3.8840071581049105E+00; 
            // tol_tr: 2.2204460492503131E-15; 

            // x: 1.1671643538151033E+00, 2.2515425071373287E+00; 
            // c: 1.7334598164392505E+00; 
            // gx: -3.8732557884174823E+00; 
            // xHx: 1.9366278364291103E+00; 
            // fval: -2.0316813554912128E-01; 
            // Trial point found (output data):
            //   1.1671643538151033,   2.2515425071373287; 
            // [ From improve_model_nfp(): ]
            // points_shifted: 0.0000000000000000E+00, 0.0000000000000000E+00; 
            // points_shifted: 3.1472368639317894E-01, 4.0579193707561911E-01; 
            // points_shifted: 1.3147236863931557E+00, 4.0579193707561201E-01; 
            // points_shifted: 3.3147232863931113E+00, 2.4057899756614987E+00; 
            // points_shifted: 2.3159521053218839E+00, -1.0724232839536887E+00; 
            // points_shifted: 3.7000000000000000E+01, 5.0000000000000000E+01; 
            // points_shifted: 4.8000000000000000E+01, 4.6000000000000000E+01; 
            // points_shifted: 4.9000000000000000E+01, 5.4000000000000000E+01; 
            // points_shifted: 6.9000000000000000E+01, 4.4000000000000000E+01; 
            ...
            // Polynomial [-polynomial_max] (input data):
            prob1.pnp.col(0) <<   0.0000000000000000,   1.2904485507392154,  -1.2986718799505377,  -1.7513081132367829,   0.3360925608088252,   2.0000000000000000; 
            v_pnp.push_back(prob1.pnp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -6.4047833673671306E-01, -4.0288537260122856E+00; 
            // bu_mod: 5.2723825473804808E+00, 1.8840071581049083E+00; 
            // tol_tr: 4.4408920985006262E-15; 

            // x: 5.2723822980866268E+00, -2.3666850226225952E-01; 
            // c: 0.0000000000000000E+00; 
            // gx: 7.1110928242669882E+00; 
            // xHx: -2.4704811295967126E+01; 
            // fval: -1.7593718471700136E+01; 
            ...
            // x: -3.6326339029668989E-02, -4.0288536833167194E+00; 
            // c: -0.0000000000000000E+00; 
            // gx: -5.1852817154040745E+00; 
            // xHx: -1.6279694810147742E+01; 
            // fval: -2.1464976525551815E+01; 

            // New points (output data) - > new_points = [new_point_max, new_point_min];:
            //  -0.0363263390296690,  -4.0288536833167194; 
            //   5.2723822980866268,  -0.2366685022622595; 

            // ------------------------------------------------------------------------------------------
            // C++ POINT SOLVE TR SUBPROBLEM 

            // Polynomial [-polynomial_max] (input data):
            prob1.obp.col(0) <<   1.0000000000000000,  -2.0000000000000013,   0.0000000000000005,   2.0000000000000004,   0.0000000000000002,   0.0000000000000000; 
            v_obp.push_back(prob1.obp);
            ...
            // x: 1.0000000013288075E+00, 9.2757671604630787E-01; 
            // c: 1.0000000000000000E+00; 
            // gx: -2.0000000026576159E+00; 
            // xHx: 1.0000000026576152E+00; 
            // fval: -6.6613381477509392E-16; 
            // Trial point found (output data):
            //   1.0000000013288075,   0.9275767160463079; 

            // ------------------------------------------------------------------------------------------
            // C++ POINT SOLVE TR SUBPROBLEM 

            // Polynomial [-polynomial_max] (input data):
            prob1.obp.col(0) <<  -0.1219498875984087,   0.1159521066506915,   0.0064660751934396,   0.0000000000000000,   0.0000000000000000,   0.0000000000000000; 
            v_obp.push_back(prob1.obp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -1.6132257079060519E-01, -2.3374585607310483E-01; 
            // bu_mod: 2.1613225734482202E+00, 2.0888992881657207E+00; 
            // tol_tr: 2.2204460492503131E-15; 

            // x: -1.6132257079059534E-01, -2.3374585607308926E-01; 
            // c: -1.2194988759840872E-01; 
            // gx: -2.0217110214998345E-02; 
            // xHx: 0.0000000000000000E+00; 
            // fval: -1.4216699781340705E-01; 
            // Trial point found (output data):
            //  -0.1613225707905953,  -0.2337458560730893; 
            // [ From improve_model_nfp(): ]
            // points_shifted: 0.0000000000000000E+00, 0.0000000000000000E+00; 
            // points_shifted: 1.1595210399307665E-01, 3.3306690738754696E-15; 
            // points_shifted: 1.6716435248629580E-01, 1.3239657910910210E+00; 
            // points_shifted: 3.7000000000000000E+01, 5.0000000000000000E+01; 
            // points_shifted: 4.8000000000000000E+01, 4.6000000000000000E+01; 
            // points_shifted: 4.9000000000000000E+01, 5.4000000000000000E+01; 
            // points_shifted: 6.9000000000000000E+01, 4.4000000000000000E+01; 
            ...
            // Polynomial [-polynomial_max] (input data):
            prob1.pnp.col(0) <<   0.0000000000000000,  -0.1159521039930765,  -0.0064660751934396,   2.0000000000000000,   0.0000000000000000,   0.0000000000000000; 
            v_pnp.push_back(prob1.pnp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -1.1613225721194127E+00, -1.1613225721194127E+00; 
            // bu_mod: 1.1613225721194127E+00, 1.1613225721194127E+00; 
            // tol_tr: 2.2204460492503131E-15; 

            // x: 5.7976113704410533E-02, 1.1612447419672680E+00; 
            // c: 0.0000000000000000E+00; 
            // gx: -1.4231148184914957E-02; 
            // xHx: 3.3612297602667388E-03; 
            // fval: -1.0869918424648219E-02; 
            ...
            // x: -1.1613217519755203E+00, -1.1610133066684503E+00; 
            // c: -0.0000000000000000E+00; 
            // gx: -1.4216489989598943E-01; 
            // xHx: -1.3486682116114921E+00; 
            // fval: -1.4908331115074815E+00; 

            // New points (output data) - > new_points = [new_point_max, new_point_min];:
            //  -1.1613217519755203,  -1.1610133066684503; 

            // ------------------------------------------------------------------------------------------
            // C++ POINT SOLVE TR SUBPROBLEM 

            // Polynomial [-polynomial_max] (input data):
            prob1.obp.col(0) <<   0.9534333300469684,  -0.7009820909115251,  -1.0759392534745138,   0.4336617596228570,   0.3860925295373957,   0.3965688619335346; 
            v_obp.push_back(prob1.obp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: 4.1933871526910227E-01, 3.4691542998660263E-01; 
            // bu_mod: 1.5806612873885126E+00, 1.5082380021060131E+00; 
            // tol_tr: 2.2204460492503131E-15; 

            // x: 4.1933903820135565E-01, 1.5082379389429055E+00; 
            // c: 9.5343333004696840E-01; 
            // gx: -1.9167215578873833E+00; 
            // xHx: 7.3337172432837949E-01; 
            // fval: -2.2991650351203541E-01; 
            // Trial point found (output data):
            //   0.4193390382013557,   1.5082379389429055; 
            // [ From improve_model_nfp(): ]
            // points_shifted: 0.0000000000000000E+00, 0.0000000000000000E+00; 
            // points_shifted: 1.1595210399307665E-01, 3.3306690738754696E-15; 
            // points_shifted: 1.6716435248629580E-01, 1.3239657910910210E+00; 
            // points_shifted: -1.1613217519755203E+00, -1.1610133066684503E+00; 
            // points_shifted: 3.7000000000000000E+01, 5.0000000000000000E+01; 
            // points_shifted: 4.8000000000000000E+01, 4.6000000000000000E+01; 
            // points_shifted: 4.9000000000000000E+01, 5.4000000000000000E+01; 
            // points_shifted: 6.9000000000000000E+01, 4.4000000000000000E+01; 
            ...
            // Polynomial [-polynomial_max] (input data):
            prob1.pnp.col(0) <<   0.0000000000000000,   0.1199620329839509,  -0.1604746633912330,  -2.0691652648426699,   1.0000000000000000,   0.0000000000000000; 
            v_pnp.push_back(prob1.pnp);

            // [ From minimize_tr(): ]
            // Bounds/tolerance computed (intermediate data):
            // bl_mod: -5.8066128605970524E-01, -5.8066128605970524E-01; 
            // bu_mod: 5.8066128605970524E-01, 5.8066128605970524E-01; 
            // tol_tr: 2.2204460492503131E-15; 

            // x: -5.8066127554505220E-01, 5.8066125907410315E-01; 
            // c: 0.0000000000000000E+00; 
            // gx: -1.6283872718368478E-01; 
            // xHx: -6.8599516457314769E-01; 
            // fval: -8.4883389175683244E-01; 
            ...
            // x: -2.2264900610628768E-01, -5.8066024201134203E-01; 
            // c: -0.0000000000000000E+00; 
            // gx: -6.6471829467075610E-02; 
            // xHx: -7.7996495539589372E-02; 
            // fval: -1.4446832500666498E-01; 

            // New points (output data) - > new_points = [new_point_max, new_point_min];:
            //  -0.5806612755450522,   0.5806612590741032; 
            //  -0.2226490061062877,  -0.5806602420113420; 

            // ------------------------------------------------------------------------------------------
            // C++ POINT SOLVE TR SUBPROBLEM 

            // Polynomial [-polynomial_max] (input data):
            prob1.obp.col(0) <<   1.0046720476856412,  -1.6207565024594019,  -0.2499336438992850,   1.8470566095417056,  -0.2344097789001354,   0.3296654305552945; 
            v_obp.push_back(prob1.obp);
            ...
            // x: 1.0688685286269897E+00, 1.5080614230067844E+00; 
            // c: 1.0046720476856412E+00; 
            // gx: -2.1092909047224335E+00; 
            // xHx: 1.0521335655553123E+00; 
            // fval: -5.2485291481479956E-02; 
            // Trial point found (output data):
            //   1.0688685286269897,   1.5080614230067844; 
            // [ From improve_model_nfp(): ]
            // points_shifted: 0.0000000000000000E+00, 0.0000000000000000E+00; 
            // points_shifted: 1.1595210399307665E-01, 3.3306690738754696E-15; 
            // points_shifted: 1.6716435248629580E-01, 1.3239657910910210E+00; 
            // points_shifted: -1.1613217519755203E+00, -1.1610133066684503E+00; 
            // points_shifted: -5.8066127554505220E-01, 5.8066125907410315E-01; 
            // points_shifted: 3.7000000000000000E+01, 5.0000000000000000E+01; 
            // points_shifted: 4.8000000000000000E+01, 4.6000000000000000E+01; 
            // points_shifted: 4.9000000000000000E+01, 5.4000000000000000E+01; 
            // points_shifted: 6.9000000000000000E+01, 4.4000000000000000E+01; 
            ...
            // Polynomial [-polynomial_max] (input data):
            prob1.pnp.col(0) <<   0.0000000000000000,   0.0537942600945873,  -1.0832403345517601,  -0.9278703575359597,  -1.4221071254289022,   2.0000000000000000; 
            v_pnp.push_back(prob1.pnp);
            ...
            // x: 5.8066098088998874E-01, 5.8066075107234860E-01; 
            // c: 0.0000000000000000E+00; 
            // gx: -5.9775891841991291E-01; 
            // xHx: -2.9874445751317813E-01; 
            // fval: -8.9650337593309104E-01; 
            ...
            // x: 5.8066105130322665E-01, -5.8066126000383278E-01; 
            // c: -0.0000000000000000E+00; 
            // gx: -6.6023192916840068E-01; 
            // xHx: -6.6023187771778635E-01; 
            // fval: -1.3204638068861869E+00; 

            // New points (output data) - > new_points = [new_point_max, new_point_min];:
            //   0.5806610513032266,  -0.5806612600038328; 
            //   0.5806609808899887,   0.5806607510723486; 
