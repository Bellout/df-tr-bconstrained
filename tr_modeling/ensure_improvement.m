function [model, exitflag, prob] = ensure_improvement(model, ...
  ...
  if ~model_complete && (~model_old || ~model_fl)
    ...
    fprintf(prob.fid_improveModelNfp, ['[ ensureImprovement()[1] ]\n']);
  ...
  elseif model_complete && ~model_old
    ...
    fprintf(prob.fid_chooseAndReplacePoint, ['[ ensureImprovement()[1] ]\n']);
  ...
  if ~success
    ...
    if ~changed
      if ~model_complete
        ...
        fprintf(prob.fid_improveModelNfp, ['[ ensureImprovement()[2] ]\n']);
        [model, success, prob] = improve_model_nfp(model, ...
                                             funcs, ...
                                             bl, bu, ...
                                             options, ...
        ...
        fprintf(prob.fid_chooseAndReplacePoint, ['[ ensureImprovement()[2] ]\n']);
        [model, success, prob] = choose_and_replace_point(model, ...
                                                    funcs, ...
                                                    bl, bu, ...
                                                    options, ...
